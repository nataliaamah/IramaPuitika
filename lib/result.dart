...
const Color backgroundSolid =
    Color.fromARGB(255, 63, 124, 96); // Matching HomePage background
const Color lightGoldAccent = Color(0xFFF5EAD0); // Keeping existing accent
const Color cardOverlay =
    Color(0xFF1A3A32); // Subtle dark overlay for better text contrast
...
class _ResultScreenState extends State<ResultScreen>
  ...
  Animation<double>?
      _swayAnimation; // Make nullable to avoid LateInitializationError
                  ...
                  : FadeInUp(
                      ...
                      child: Column(
                        children: [
                          ...
                          // IMPROVED: Floating action buttons for navigation
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  // IMPROVED: Counter with better styling
                                  Container(
                                    ...
                                    child: Text(
                                      "${currentIndex + 1} of ${widget.result.length}",
                                      style: GoogleFonts.poppins(
                                        fontSize: screenWidth * 0.035,
                                        color: goldText,
  ...
  // IMPROVED: Better floating navigation buttons
  ...
  Widget _pantunCard(
      BuildContext context, Map<String, dynamic> pantunData, double screenWidth,
      {bool isDimmed = false}) {
    ...
    switch (theme.toLowerCase()) {
      ...
      default:
        backgroundImagePath =
            'assets/images/default_paper_style_background.png';
    }

    // Process the pantun string
    String pantunText =
        pantunData['pantun'] as String? ?? 'Pantun not available';
              ...
              onTap: () {
                if (!isDimmed) {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          PantunDetailScreen(pantunData: pantunData),
                    ),
                  );
                }
              },
              child: Container(
                // This container provides the overall shape/decoration
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Stack(
                  children: [
                    ...
                    Positioned.fill(
                      // Ensure the image layer fills the stack
                      child: Transform.scale(
                        // Apply scale specifically to the background image
                        scale:
                            1.1, // Adjust this value to control the zoom level
                        child: Image.asset(
                          backgroundImagePath,
                          fit: BoxFit
                              .cover, // Image should cover the scaled area
                          errorBuilder: (context, error, stackTrace) {
                            debugPrint(
                                'Error loading image $backgroundImagePath: $error');
                  ...
                  */
                    ...
                    // Text content layer
                    Positioned.fill(
                      // Ensure the text layer fills the stack
                      child: Padding(
                        padding: const EdgeInsets.symmetric(
